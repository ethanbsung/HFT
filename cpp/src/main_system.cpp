...
//                 std::cout << "📊 DEBUG: Slippage: " << slippage_bps << " bps" << std::endl;
        ...
        std::cout << "   • Quote Size: " << signal_config.default_quote_size << " BTC (Aggressive small sizes)" << std::endl;
        std::cout << "   • Target Spread: " << signal_config.target_spread_bps << " bps (Aggressive)" << std::endl;
        std::cout << "   • Max Position: " << signal_config.max_position << " BTC (Aggressive)" << std::endl;
        std::cout << "   • Max Orders/sec: " << signal_config.max_orders_per_second << " (Aggressive frequency)" << std::endl;
        std::cout << "   • Quote Refresh: " << signal_config.quote_refresh_ms << " ms (Aggressive fast)" << std::endl;
        std::cout << "   • Aggressive Mode: " << (signal_config.enable_aggressive_quotes ? "ENABLED" : "DISABLED") << std::endl;
        std::cout << "   • Strategy: Inside-spread quoting when possible, join best bid/ask otherwise (Aggressive)" << std::endl;
        ...
        while (g_running) {
            ...
            // More frequent cleanup of stale quotes for active trading
            ...
            // Print status more frequently for better monitoring
